...
NAN_MODULE_INIT(init) {
	Nan::Set(target, Nan::New("cuckarood29v").ToLocalChecked(), Nan::GetFunction(Nan::New<FunctionTemplate>(cuckarood29v)).ToLocalChecked());
	Nan::Set(target, Nan::New("cycle_hash").ToLocalChecked(), Nan::GetFunction(Nan::New<FunctionTemplate>(cycle_hash)).ToLocalChecked());
}

NODE_MODULE(cuckarood29v, init)
